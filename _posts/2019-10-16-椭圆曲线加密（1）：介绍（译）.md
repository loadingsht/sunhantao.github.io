...
其中$4a^3 + 27b^2 \ne 0$（这个保证了曲线是非[奇异](http://mathworld.wolfram.com/EllipticCurve.html)的）。上面的等式被称作椭圆曲线的Weierstrass标准形式。
 ...
 <figure>
  <img src="/public/upload/ecc/curves.png" alt="Different shapes for different elliptic curves" width="440" height="450">
...
<script src="//cdnjs.cloudflare.com/ajax/libs/mathjax/2.6.1/MathJax.js" async defer></script>
<script src="//cdnjs.cloudflare.com/ajax/libs/mathjax/2.6.1/config/TeX-AMS_HTML.js" async defer></script>