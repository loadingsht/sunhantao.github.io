...
椭圆曲线密码学系列文章链接：
1. [实数上的椭圆曲线和群法则](http://sunhantao.github.io/2018/10/16/椭圆曲线密码学-1-介绍-译)
2. [有限域上的椭圆曲线和离散对数问题](http://sunhantao.github.io/2018/10/16/椭圆曲线密码学-2-有限域和离散对数-译)（就是本篇）
3. [密钥对的生成以及两种ECC算法：ECDH和ECDSA](http://sunhantao.github.io/2018/10/16/椭圆曲线密码学-3-ECDH和ECDSA-译)
4. [破坏ECC安全性的算法，和RSA的比较](http://sunhantao.github.io/2018/10/16/椭圆曲线密码学-4-攻击安全以及ECC与RSA的比较-译)
  
在[上一篇](http://sunhantao.github.io/2018/10/16/椭圆曲线密码学-1-介绍-译)文章中，我们知道椭圆曲线如何在实数上定义群。尤其是定义了点的加法法则：给定三个共线的点，它们的和等于0($P + Q + R = 0$)。并且推导出计算点加法的[几何方法](http://sunhantao.github.io/2018/10/16/椭圆曲线密码学-1-介绍-译/#几何加法)和[代数方法](http://sunhantao.github.io/2018/10/16/椭圆曲线密码学-1-介绍-译/#代数方法)。
